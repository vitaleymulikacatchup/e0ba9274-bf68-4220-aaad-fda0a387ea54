...
export const metadata: Metadata = {
  ...
  description: "Experience the best pizzeria in town with authentic Italian flavors.",
  openGraph: {
    title: "Pizzeria - Authentic Italian Pizza",
    description: "Experience the best pizzeria in town with authentic Italian flavors.",
    url: "",
    siteName: "Pizzeria",
    images: [{ url: "https://images.pexels.com/photos/2909822/pexels-photo-2909822.jpeg?auto=compress&cs=tinysrgb&h=650&w=940", alt: "Delicious Pizza" }],
    type: "website"
  },
  twitter: {
